...
class DubboConsumerInvocationProcessor extends DefaultInvocationProcessor {
    ...
    public Identity assembleIdentity(BeforeEvent event) {
        ...
        try {
            ...
            // ignore
            log.error("error occurred when assemble dubbo request", e);
        }
    ...
    public Object assembleMockResponse(BeforeEvent event, Invocation invocation) {
        ...
        try {
            ...
            log.error("no valid AsyncRpcResult class fount in classloader {}", event.javaClassLoader, e);
            return null;
        } catch (Exception e) {
            log.error("error occurred when assemble dubbo mock response", e);
            return null;
        }
    }
    ...
    public Object assembleResponse(Event event) {
        ...
        if (event.type == Event.Type.BEFORE) {
            ...
            try {
                ...
                // ignore
                log.error("error occurred when assemble dubbo response", e);
            }
        }
        return null;
    }
