...
public class ApacheHttpClientProcessor extends DefaultInvocationProcessor {
    ...
    private static final String DEFAULT_REQUEST_BODY_STR = "apacheHttpClient-plugin request body is not repeatable";

    private static final String DEFAULT_RESPONSE_BODY_STR = "apacheHttpClient-plugin response body is not repeatable";
    ...
    public Object[] assembleRequest(BeforeEvent event) {
        ...
        try {
            ...
            log.error("apacheHttpClient-plugin assembleRequest error, event={}",
                    event.javaClassName + "|" + event.javaMethodName, e);
        }
    ...
    private String getRequestBody(Object request, ClassLoader classLoader) throws Exception {
        ...
        if (!isRepeatable) {
            log.warn("apacheHttpClient-plugin request body is not repeatable");
    ...
    public Object assembleResponse(Event event) {
        ...
        try {
            ...
            log.error("apacheHttpClient-plugin copy response error", e);
        }
        ...
        if (isRepeatable) {
            ...
            if (this.canResetContent(httpEntity, classLoader)) {
                ...
                if (this.canResetContent(httpEntityInside, classLoader)) {
                    ...
                    return DEFAULT_RESPONSE_BODY_STR;
                }
            }
        }
    }
