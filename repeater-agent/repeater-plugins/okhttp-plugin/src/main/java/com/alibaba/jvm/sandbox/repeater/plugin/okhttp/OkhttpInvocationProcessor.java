...
public class OkhttpInvocationProcessor extends DefaultInvocationProcessor {
    ...
    public Identity assembleIdentity(BeforeEvent event) {
        ...
        try {
            ...
            log.error("okhttp-plugin assembleIdentity get url error", e);
        }
    ...
    public Object[] assembleRequest(BeforeEvent event) {
        ...
        try {
            ...
            log.error("okhttp-plugin assembleRequest error, event={}",
    ...
    private Object getRequestFromEvent(BeforeEvent event) {
        ...
        try {
            ...
            log.error("okhttp-plugin getRequestFromEvent error", e);
        }
    ...
    public Object assembleResponse(Event event) {
        ...
        if (event.type == Event.Type.RETURN) {
            ...
            try {
                ...
                log.error("okhttp-plugin copy response error", e);
            }
        }
    ...
    public Object assembleMockResponse(BeforeEvent event, Invocation invocation) {
        ...
        try {
            ...
            if (inputStream == null) {
                log.error("okhttp-plugin get response stream error");
                return new Object();
            }
            ...
            log.error("okhttp-plugin assembleMockResponse error, event={}",
                    event.javaClassName + "|" + event.javaMethodName, e);
        }
