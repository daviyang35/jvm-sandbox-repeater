...
public class HttpUtil {
    ...
    public static Resp doGet(String url, Map<String, String> params) {
        ...
        return doGet(httpBuilder.build().toString());
    }
    ...
    private static Resp invokeGet(String url,
        ...
        if (MapUtils.isNotEmpty(paramsMap)) {
            HttpUrl.Builder builder = uri.newBuilder();
        ...
        Request.Builder rb = new Request.Builder().get().url(uri);
        if (MapUtils.isNotEmpty(headers)) {
            for (Map.Entry<String, String> entry : headers.entrySet()) {
    ...
    public static Resp invokePostBody(String url,
        ...
        Request.Builder request = new Request.Builder().post(requestBody).url(uri);
        if (MapUtils.isNotEmpty(headers)) {
            for (Map.Entry<String, String> entry : headers.entrySet()) {
        ...
        // fix issue #70
        return executeRequest(request.build(), 0);
    }
